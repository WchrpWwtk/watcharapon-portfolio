        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          ...
          <div className="space-y-6 text-lg leading-8 text-slate-600">
            <p>
              ...
              Next.js interfaces to Django, FastAPI, Node.js, NestJS,
              PostgreSQL, Docker, and deployment workflows.
            </p>
            <p>
              My focus is not only making screens look good, but making the
              system useful: clear data flow, understandable APIs, maintainable
