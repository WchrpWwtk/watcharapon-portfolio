export const projects = [
  {
    title: "Incident Board System",
    label: "Featured Case Study",
    description:
      "A full-stack web application for tracking incidents, statuses, and operational issues in a business workflow.",
    problem:
    ...
    highlights: [
      ...
      "Incident tracking and status visibility",
